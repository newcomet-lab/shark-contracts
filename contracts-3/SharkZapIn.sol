...
contract Shark_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    mapping(IShrkBondDepository => address) public allowedReserves;
    ...
    constructor() {
        ...
        //allowedPairs
        allowedPairs[
            IShrkBondDepository(0xc26850686ce755FFb8690EA156E5A6cf03DcBDE1)
        ] = 0xf64e1c5B6E17031f5504481Ac8145F4c3eab4917;
        allowedPairs[
            IShrkBondDepository(0xA184AE1A71EcAD20E822cB965b99c287590c4FFe)
        ] = 0x113f413371fC4CC4C9d6416cf1DE9dFd7BF747Df;

        //allowedReserves
        allowedReserves[
            IShrkBondDepository(0x694738E0A438d90487b4a549b201142c1a97B556)
        ] = 0x130966628846BFd36ff31a822705796e8cb8C18D;
        allowedReserves[
            IShrkBondDepository(0xE02B1AA2c4BE73093BE79d763fdFFC0E3cf67318)
        ] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;
    }

    event zapIn(address sender, address pool, uint256 tokensRec);

    function addPairAddress(address bondDepository, address pair)
        external
        onlyOwner
    {
        require(bondDepository != address(0), "BNA");
        require(pair != address(0), "BNA");
        allowedPairs[IShrkBondDepository(bondDepository)] = pair;
    }

    function removePairAddress(address bondDepository) external onlyOwner {
        require(bondDepository != address(0), "BNA");

        allowedPairs[IShrkBondDepository(bondDepository)] = address(0);
    }

    function addReserveAddress(address bondDepository, address reserve)
        external
        onlyOwner
    {
        require(bondDepository != address(0), "BNA");
        require(reserve != address(0), "BNA");
        allowedReserves[IShrkBondDepository(bondDepository)] = reserve;
    }

    function removeReserveAddress(address bondDepository) external onlyOwner {
        require(bondDepository != address(0), "BNA");

        allowedReserves[IShrkBondDepository(bondDepository)] = address(0);
    }
    ...
    function ZapInLp(
        ...
        IShrkBondDepository _bondDepository,
        uint256 _amount,
        uint256 _minPoolTokens,
        address _swapTarget,
        bytes calldata swapData,
        bool transferResidual,
        uint256 _bondMaxPrice,
        address _to
        ...
        uint256 LPBought = _performZapInLp(
