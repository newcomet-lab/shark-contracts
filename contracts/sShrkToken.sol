...
contract StakedShrk is ERC20Permit, Ownable {
    ...
    constructor() ERC20("StakedShrk", "sSHRK", 9) ERC20Permit() {
    ...
    /**
        @notice increases sSHRK supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSHRK
