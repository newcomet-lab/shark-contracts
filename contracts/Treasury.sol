...
contract SharkTreasury is Ownable {
    ...
    uint256 public sSHRKQueue; // Delays change to SSHRK address
    ...
    function incurDebt(uint256 _amount, address _token) external {
        ...
        uint256 maximumDebt = IERC20(sSHRK).balanceOf(msg.sender); // Can only borrow against SSHRK held
    ...
    /**
        ...
        @param _amount uint
     */
    function repayDebtWithSHRK(uint256 _amount) external {
        require(isDebtor[msg.sender], "Not approved");
        ...
        returns (uint256 value_)
    {
        if (isReserveToken[_token]) {
            ...
            value_ = _amount.mul(10**IERC20(Shrk).decimals()).div(
        ...
        returns (bool)
    {
        ...
        } else if (_managing == MANAGING.SSHRK) {
            // 9
